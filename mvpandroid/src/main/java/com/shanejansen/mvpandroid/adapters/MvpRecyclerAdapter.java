 ...
 * Recycler adapter for the MVP architecture. Automatically updated the view when data transactions
 * are preformed on the adapter.
 */
public abstract class MvpRecyclerAdapter<T, VH extends RecyclerView.ViewHolder>
